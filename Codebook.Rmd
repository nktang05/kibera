...
data_values <- read_csv("~/Desktop/GRIT/Kibera/kibera_labels.data.csv")
data_labels <- read_csv("~/Desktop/GRIT/Kibera/kibera_values_data.csv")
...
write_csv(codebook_df, "~/Desktop/GRIT/Kibera/auto_generated_codebook.csv")
...
saveRDS(data_values, file = "~/Desktop/GRIT/Kibera/codebook_labelled_data.rds")
